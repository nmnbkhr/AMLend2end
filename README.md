...
![intall_python_lib_from_git.png](./images/intall_python_lib_from_git.png)

## End to End pipeline
To successfully complete this tutorial clone this repository to your Hopsworks project ![git_clone.png](./images/git_clone.png)
